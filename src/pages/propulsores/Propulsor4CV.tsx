...
const Propulsor4CV = () => {
  ...
  const specs = [
    { label: t("propulsors.power"), value: "4 CV", icon: Zap },
    { label: t("propulsors.capacity"), value: t("propulsors.p4cv.capacity"), icon: Gauge },
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="animate-fade-in">
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-foreground tracking-tight">{t("propulsors.p4cv.title")}</h1>
            <p className="text-sm text-muted-foreground">{t("propulsors.p4cv.subtitle")}</p>
          </div>
        </div>
      </div>
