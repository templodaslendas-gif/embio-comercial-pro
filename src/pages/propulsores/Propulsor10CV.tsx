...
const Propulsor10CV = () => {
  ...
  const specsByAnimal: Record<string, { label: string; value: string; icon: any }[]> = {
    suino: [
      { label: t("propulsors.power"), value: "10 CV", icon: Zap },
      { label: t("propulsors.capacity"), value: t("propulsors.p10cv.capacitySwine"), icon: Gauge },
      { label: t("propulsors.application"), value: t("propulsors.swineManure"), icon: Droplets },
    ],
    bovino: [
      { label: t("propulsors.power"), value: "10 CV", icon: Zap },
      { label: t("propulsors.capacity"), value: t("propulsors.p10cv.capacityBovine"), icon: Gauge },
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="animate-fade-in">
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-foreground tracking-tight">{t("propulsors.p10cv.title")}</h1>
        ...
        <div className="space-y-3 animate-fade-in">
          ...
          <Alert variant="destructive" className="border-destructive/30 bg-destructive/10">
            ...
            <AlertDescription className="text-sm font-medium">
              {animal === "suino" ? t("propulsors.p10cv.warningSwine") : t("propulsors.p10cv.warningBovine")}
            </AlertDescription>
          </Alert>
        </div>
      )}
